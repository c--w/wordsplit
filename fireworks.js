$("body").append($('<canvas id="c" style="display: none; position: absolute; top: 0; left: 0;background-color: #0008;"></canvas>'))
...
var fireworks_running;
function anim() {
    if (!fireworks_running)
        return;
...
function startFireworks() {
    fireworks_running = true;
    $('#c').show();
    anim();
}

function stopFireworks() {
    fireworks_running = false;
    $('#c').hide();
}
